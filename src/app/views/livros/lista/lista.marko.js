...
function render(input, out, __component, component, state) {
  ...
  out.w("<html><head><title>Hawks Library</title><meta charset=\"utf-8\"></head><body>");

  component_globals_tag({}, out);

  out.w("<h1>Página de livros</h1><table id=\"livros\"><tr><td>ID</td><td>Título</td><td>Descrição</td><td>Editar</td><td>Remover</td></tr>");
